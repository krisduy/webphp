...
// --- Thêm các cột cần thiết nếu chưa tồn tại (MySQL chuẩn không hỗ trợ IF NOT EXISTS cho nhiều cột cùng lúc, có thể cần tách riêng) ---
...
// --- Nếu người dùng bấm nút Gửi form liên hệ ---
if (isset($_POST['submit'])) {

    // Lấy dữ liệu từ form và escape để tránh SQL Injection
