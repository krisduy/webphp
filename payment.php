...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> Thanh Toán
             (<?php
            ...
            <li><a href="logout_u.php"><span class="glyphicon glyphicon-log-out"></span>Đăng Xuất</li>
          </ul>
  <?php        
}
else {
...
<h5 class="text-center">Bao gồm tất cả khoản phí dịch vụ. (Không áp dụng phí giao hàng)</h5>
<br>
<h1 class="text-center">
  ...
  <a href="onlinepay.php"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Thanh Toán Trực Tuyến</button></a>
  <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Tiền Mặt Khi Giao Hàng</button></a>
</h1>
