...
<?php
// Nếu đăng nhập bằng tài khoản admin (login_user1)
...
// Nếu đăng nhập bằng tài khoản user (login_user2)
...
<div class="wide2">
  ...
  <div class="col-xs-4 box">
    <h2><strong>Không Giới Hạn<br> Số Lượng Đặt Hàng </strong><hr></h2>
    <h4>Bạn Muốn Đặt Bao Nhiêu Tùy Ý.</h4>
  </div>
  <div class="col-xs-4 box">
    <h2><strong>Theo Dõi Đơn Hàng<br> Trực Tiếp </strong><hr></h2>
    <h4>Biết Ngay Đơn Hàng Của Bạn Ở Đâu, Bất Cứ Lúc Nào!</h4>
  </div>
  <div class="col-xs-4 box">
    <h2><strong>Giao Hàng<br> Nhanh Chóng </strong><hr></h2>
    <h4>Đồ Ăn Nóng Hổi Giao Tận Tay!</h4>
  </div>
</div>
...
<div class="paragraph1" style="background-color: #f0f8ff; padding: 20px; border-radius: 10px;">
  ...
  <h4 style="color: #333;">
    <span style="color: #007acc; font-weight: bold;">HUYFOOD</span> luôn sẵn sàng mang đến những trải nghiệm ẩm thực tuyệt vời cho bạn.  
    Mỗi bữa ăn được chuẩn bị với tâm huyết và sự tận tâm, tạo nên những khoảnh khắc đáng nhớ.  
    Khách đến, bạn có dịp chia sẻ niềm vui và sự ấm áp qua những hương vị hấp dẫn.  
  </h4>

  <p style="color: #555;">
    Chúng tôi tin rằng "Khách đến nhà như trời đến nhà" – và với 
    <span style="color: #007acc; font-weight: bold;">HUYFOOD</span>, 
    mỗi bữa ăn đều mang đến niềm vui và sự thoải mái trọn vẹn.
  </p>
</div>
